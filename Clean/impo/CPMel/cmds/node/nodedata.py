...
class Global(object):
    ...
    def objToNode(obj):
        ...
        try:
            ...
            #             cla = Global.DependencyNodeTypes[i]
            #             Global.DependencyNodeTypes[api_type] = cla
            #             # print ">>>", i, Global.DependencyNodeTypes[i]
            #             o = cla(obj, uuid, uuid_s)
            #             Global.NewNodes[uuid_s] = o
            #             return o
            #     o = DgNode(obj, uuid, uuid_s)
            #     Global.NewNodes[uuid_s] = o
            #     return o
...
class DgNode(CPObject):
    ...
    def rename(self, p_str):
        ...
        :return: Unicode 新名称
        """
        return cmds.rename(str(self), p_str)
...
class AttrObject(CPObject):
    ...
    def cp__attrname(self):
        ...
        :return:
        """
        return "%s.%s" % (self.cp__node.name(), self.cp__attrPartialName())
    ...
    def connect(self, attr):
        ...
        :return:
        """
        return cmds.connectAttr(self.cp__attrname(), attr.cp__attrname(), f = True)
    ...
    def disConnect(self, attr):
        ...
        :return:
        """
        return cmds.disconnectAttr(self.cp__attrname(), attr.cp__attrname())
